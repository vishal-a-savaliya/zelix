    ...
    return (
        <footer className="bg-white">
            <div className="px-4 py-16 mx-auto max-w-screen-xl sm:px-6 lg:px-8">
                <div className="flex flex-col items-center p-6 bg-[#23e6a8] rounded-lg shadow-lg gap-4 sm:flex-row sm:justify-between">
                    <strong className="text-xl text-white sm:text-xl">
                        Grow your Business Now!
                    </strong>
                    <a className="inline-flex items-center px-8 py-3 text-[#23e6a8] bg-white border border-white rounded-full hover:bg-transparent hover:text-white active:bg-white/90 focus:outline-none focus:ring" href="/">
